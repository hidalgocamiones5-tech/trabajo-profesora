...
components.append({'id': 'api_layer', 'type': 'backend', 'label': 'API Api', 'sublabel': 'Django Views', 'row': 0, 'col': 1, 'size': [220, 60]})
...
for model in models:
    ...
    connections.append({'from': 'api_layer', 'to': node_id, 'variant': 'dashed', 'fromSide': 'bottom'})
