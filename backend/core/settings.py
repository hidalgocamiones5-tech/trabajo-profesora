...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-aprudqrus75xe-8%w47my*#77d59nsbcm7!e-=%wv=3%&8n)7a')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['*'] # In production, set this to your Render app URL, but for ease of use we allow all.
...
# CORS configuration
CORS_ALLOW_ALL_ORIGINS = True # Allow all in production/demo
